...
local DefuseService = require(Services:WaitForChild("DefuseService"))
...
safeInit("DefuseService", DefuseService.init, DataService, BotService, WeaponService, net)
safeInit("EggService",    EggService.init, DataService, net)
safeInit("LobbyService",  LobbyService.init, ArenaService, EggService, DefuseService, DataService, net)
...
WeaponService.setDefuseService(DefuseService)
